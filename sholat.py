# sholat
# Mr.TamfanX
# created 24, April 202p 21:21PM
# updated 24-4-2020 21:21PM
#-*-coding : utf-8-*-
'''
...
{lg}Nama        : {lw}Sholat
{lg}Versi       : {lw}2.0 (update: 24-4-2020, 21:21PM)
{lg}Tanggal     : {lw}24-April-2020, 21:18PM
{lg}Author      : {lw}Mr.TamfanX
{lg}Tujuan      : {lw}Mengingatkan Kita Pada
              Waktu Sholat
{lg}Terimakasih : {lw}Allah SWT
              Mr.TamfanX, SIT Dan Semua
              Umat Muslim seplanet bumi.
{lg}NB          : {lw}Manusia nggak ada yang sempurna,
              sama kaya tool ini.
              Silahkan laporkan kritik atau saran
              ke:  - https://www.youtube.com/channel/UC0LsiFgUAbd03TJXiT4Eo7Q
